...
<div class="tabs">
  <div role="tablist" class="automatic tabs__tablist">
    ...
    <?php foreach($params->get('items') as $item): ?>
      <button id="tab-<?php echo $navindex; ?>" type="button" role="tab" aria-selected="<?php echo $navindex === 1 ? 'true' : 'false' ;?>" aria-controls="tabpanel-<?php echo $navindex; ?>" <?php echo $navindex > 1 ? 'tabindex="-1"' : '' ; ?>>
  ...
  <div class="tabs__panels">
    <?php $panelindex = 1; ?>
      <?php foreach($params->get('items') as $item): ?>
        <div id="tabpanel-<?php echo $panelindex; ?>" role="tabpanel" tabindex="0" aria-labelledby="tab-<?php echo $panelindex; ?>">
            <?php
